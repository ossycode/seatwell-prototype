...
import { HomeIcon, ListIcon, Ticket } from "lucide-react";
...
const navigation: NavItem[] = [
  { name: "Dashboard", path: Routes.BUYER.path, icon: <HomeIcon /> },
  {
    name: " Tickets Purchased",
    path: Routes.BUYER_PURCHASED.path,
    icon: <Ticket />,
  },
  {
    name: " Upcomming Games",
    path: Routes.BUYER_GAMES.path,
    icon: <ListIcon />,
  },
];
