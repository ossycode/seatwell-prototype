...
const PaymentCompletedModal = ({ isOpen, closeModal, ticketInfo }: Props) => {
  return (
    <Modal
      isOpen={isOpen}
      onClose={closeModal}
    ...
    >
      <div className="text-center">
        ...
        <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
          Your ticket for <strong>{ticketInfo.seat_info}</strong> has been
          successfully purchased. A confirmation has been sent to your email.
          You can view your ticket anytime from your dashboard.
        </p>
