...
import { TicketStatus, TicketWithGame } from "@/types/tickets";
...
const TicketsTable = () => {
  ...
  const [ticketToEdit, setTicketToEdit] = useState<TicketWithGame | null>(null);
  const [ticketToDelete, setTicketToDelete] = useState<TicketWithGame | null>(
    null
  );
      ...
      <div className="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-white/[0.05] dark:bg-white/[0.03]">
                              ...
                              <>
                                {["sold", "payout_issued"].includes(
                                  ...
                                  <Tooltip>
                                    ...
                                    <TooltipContent>
                                      <p>
                                        Cannot edit sold or finalized tickets
                                      </p>
                                    </TooltipContent>
                                  </Tooltip>
                                ) : (
        ...
        {ticketToDelete && (
          <WarningModal
            ...
            title="Delete Ticket"
            message={`Are you sure you want to delete this ticket for ${ticketToDelete.game.home_team.name} vs
           ${ticketToDelete.game.away_team.name}? This action is irreversible.`}
