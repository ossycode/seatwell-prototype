      ...
      >
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-700">
          ...
          >
            ...
            {hasNotifications && (
              <span className="absolute -top-1 -right-1 bg-orange-500 text-white text-xs px-1.5 py-0.5 rounded-full z-10">
          ...
          {isLoading ? (
            ...
            notifications.map((notification) => (
              <li key={notification.id}>
                <DropdownItem
                  className="flex gap-3 items-start rounded-lg border-b border-gray-100 p-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
        ...
        <Link
          href="#"
          className="block px-4 py-2 mt-auto text-sm font-medium text-center text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700"
        >
